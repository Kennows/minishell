CFILES = main.c lexing.c parsing.c redirections.c ft_token_split.c utils.c utils2.c freeing_functions.c init.c heredoc.c syntax.c expand.c expand_heredoc.c quotes.c
